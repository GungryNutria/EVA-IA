...
#define PN532_SCK  18//Naranja
#define PN532_MOSI 23//blanco Naranja
#define PN532_SS   5//Azul
#define PN532_MISO 19//Blanco Azul
...
void proceso(void*ptr){
  //AL PRESIONAR EL BOTON VERDE, SE EVALUA LA PRESENCIA DE LA TARJETA Y SI ES VERDADERA, SE CONTINUA. DE LO CONTRARIO SE MENCIONA EN LA PANTALLA
   ...
   do{ //
    ...
    if(GLOBAL_ID != ""){
      generateToken();
      ConfirmTarjeta(token,GLOBAL_ID);
    }
    

    if(codigo == "403"){
      GLOBAL_ID = "";
      labelTarjeta.setText("La tarjeta no existe");
      delay(1000);
      ESP.restart();
    }else if(codigo == "200"){
      GLOBAL_ID = GLOBAL_ID;
